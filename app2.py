...
file_name_model = 'LSTM_model_3.h5'
dev_mode=True
examples_length=50
num_examples = 0 #auto
...
for city, descr in zip(city_names,descriptions):
    #print(f"Examples for {city}:")
    examples = []
    i=0
    j=examples_length
    top_words = descr.split()
    num_examples = int(len(top_words)/examples_length)
    for _ in range(num_examples):
        example_sentence = ' '.join(top_words[i:j])
